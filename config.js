...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || '𝚫𝐃𝐑𝐈𝚵𝚴-𝚩𝚹𝚻',
    ...
    BOT_INFO: process.env.BOT_INFO || '𝚫𝐃𝐑𝐈𝚵𝚴-𝚩𝚹𝚻;ADRIEN;917439317360;https://imgur.com/a/atdPaxp',

    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? '𝚫𝐃𝐑𝐈𝚵𝚴-𝚩𝚹𝚻;ADRIEN;https://imgur.com/a/atdPaxp' : process.env.AUDIO_DATA,

    STICKER_DATA: process.env.STICKER_DATA === undefined ? '𝆺𝅥 𝇁 ֹ 𝄄 س ꓹ 𝚫𝐃𝐑𝐈𝚵𝚴 𓂃🧣' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '972528277700,917439317360',
